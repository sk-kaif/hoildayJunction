...
//       <h1 className="text-[48px] leading-14 font-bold pb-3 ">FAQ</h1>
...
//             <div
//               key={index}
//               className="border-b border-gray-200 pb-4 transition-all cursor-pointer"
//             >
//               <button
//                 className="w-full text-left bg-red-500 flex justify-between items-center font-medium text-lg"
...
//                 }}
//               >
//                 <div className="mt-2 text-gray-700 text-sm md:text-base pr-4">
//                   {faq.answer}
//                 </div>
//               </div>
//             </div>
...
export default function FAQ() {
  ...
  return (
    <section className="max-w-3xl w-[90%] mx-auto  py-10 md:py-16">
      <h1 className="text-[48px] leading-14 font-bold pb-3 text-center">FAQ</h1>
