...
//             >
//               {/* Colored Header */}
//               {/* <div className={`${t.bgColor} h-[120px] relative`}> */}
//               <div
//                 className={`bg-gradient-to-br from-blue-900 to-blue-600 h-[120px] relative`}
//               >
//                 {/* Profile Image */}
//                 <img
//                   src={t.image}
          ...
          {testimonials.map((t, idx) => (
            <SwiperSlide key={idx} className="h-full">
              <div className="bg-white rounded-xl shadow-sm overflow-hidden text-black h-full flex flex-col min-h-[340px]">
                ...
                <div className="bg-gradient-to-br from-blue-900 to-blue-600 h-[120px] relative">
                  <img
                    src={t.image}
                    alt={t.name}
                    className="w-20 h-20 rounded-full border-4 border-white absolute left-1/2 -bottom-10 transform -translate-x-1/2 object-cover"
