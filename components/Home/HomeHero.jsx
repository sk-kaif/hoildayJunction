...
//   return (
//     <main className="relative BlueBG text-white px-6 homeHero">
//       {/* 🔹 Overlay */}
...
export default function HomeHero() {
  return (
    <main className="relative BlueBG text-white px-6 homeHero">
      ...
      <section className="relative z-10 max-w-[1200px] mx-auto w-90% min-h-screen flex flex-col justify-center items-center">
        <h1 className="text-4xl md:text-6xl font-bold text-center mb-4">
          Your Trusted Ride Partner
        </h1>
