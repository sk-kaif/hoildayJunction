...
//       setSubmitStatus('Quote request submitted successfully!');
//       // Reset form...
//     } catch (error) {
...
//             <a href="tel:8447748320" className="text-blue-600 hover:underline">
//               8447748320
//             </a>
//           </p>
//         </div>
...
//                 className={`w-full py-4 px-6 rounded-md font-semibold text-white transition-all transform hover:scale-105 ${
//                   isSubmitting
...
Vehicle: ${formData.acType.toUpperCase()}
  ...
  return (
    <div
      id="price"
      className="scroll-mt-5 min-h-screen bg-gradient-to-br from-blue-900 to-blue-600  py-12 lg:py-16"
    >
