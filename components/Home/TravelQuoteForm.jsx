          ...
          <div className="p-6 md:p-8">
            ...
            <div className="flex flex-wrap gap-3 mb-8 justify-center">
              <button
                ...
                className={`px-6 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
                  formData.tripType === 'round-trip'
              ...
              <div className="pt-2">
                <button
                  ...
                  className={`w-full py-4 px-6 rounded-xl font-bold text-white transition-all duration-300 transform ${
                    isSubmitting
                      ? 'bg-gray-400 cursor-not-allowed'
                      : 'BlueBG border-1 border-black shadow-lg hover:shadow-2xl hover:scale-105 active:scale-95'
                  }`}
                >
                  {isSubmitting ? (
