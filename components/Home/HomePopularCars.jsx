...
//   return (
//     // <section className="bg-gradient-to-br from-blue-900 to-blue-600 text-white py-12 px-4 md:px-8 lg:px-16">
//     <section className="bg-black py-12 lg:py-16">
//       <div className="max-w-[1200px] mx-auto w-[90%]">
//         {/* Header */}
//         <div className=" flex items-center justify-between ">
//           <h1 className="flex-1 text-4xl lg:text-[48px] lg:leading-14 font-bold pb-6 text-white">
//             Our Vehicles
//           </h1>
//         </div>
...
//             <div
//               key={idx}
//               className="bg-[#1a1a1a] rounded-md  shadow-lg hover:shadow-xl hover:scale-[1.02] transition-transform duration-300 flex flex-col"
//             >
//               {/* Car Image */}
    ...
    <section id="vechicals" className="bg-black py-12 lg:py-16 scroll-mt-7">
      <div className="max-w-[1200px] mx-auto w-[90%]">
        ...
        >
          {cars.map((car, idx) => (
            <SwiperSlide key={idx}>
              <div className="bg-[#1a1a1a] rounded-md shadow-lg hover:shadow-xl hover:scale-[1.02] transition-transform duration-300 flex flex-col h-full">
                {/* Car Image */}
                <div className="relative h-[300px] w-full">
                  <Image
                    src={car.image}
